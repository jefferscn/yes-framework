    ...
    return ({
        resolve: {
            ...
            alias: {
                ...
                'yes-designer-icon': path.resolve(__dirname, '../src/config/font/IconFont'),
                'yes-designer-iconData': path.resolve(__dirname, '../src/config/font/iconfont.json'),
                'yes-designer-templateData': path.resolve(__dirname, '../src/template/defaultTemplateMapping'),
                'yes-designer-controls': path.resolve(__dirname, '../src/config/control'),
