...
var _uninit = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ProjectConfig.baidupush && ProjectConfig.baidupush.apiKey)) return [3 /*break*/, 2];
                return [4 /*yield*/, baidupush.uninit()];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2:
                if (!ProjectConfig.jpush) return [3 /*break*/, 4];
                return [4 /*yield*/, jpush.uninit()];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
