...
function uninit() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!registrationID) return [3 /*break*/, 2];
                    return [4 /*yield*/, unregister(registrationID, 'jpush')];
                case 1:
                    _a.sent();
                    _a.label = 2;
