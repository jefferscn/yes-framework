 ...
 * 用于显示流水单据的查询模块
 */
var AdvanceFilterBlock = /** @class */ (function (_super) {
    __extends(AdvanceFilterBlock, _super);
    function AdvanceFilterBlock() {
    ...
    AdvanceFilterBlock.prototype.componentWillReceiveProps = function (props) {
    ...
    AdvanceFilterBlock.prototype.render = function () {
        var _this = this;
        var _a = this.props, filterItems = _a.filterItems, hasMore = _a.hasMore, queryButton = _a.queryButton, style = _a.style;
    ...
    AdvanceFilterBlock.contextTypes = {
        onControlClick: PropTypes.func,
        onValueChange: PropTypes.func,
    };
    AdvanceFilterBlock.defaultProps = {
        hasMore: false,
    };
    return AdvanceFilterBlock;
}(PureComponent));
